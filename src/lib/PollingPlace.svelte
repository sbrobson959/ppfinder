<script>
	...
	$: mapImageUrl = `/api/static_map/${result.polling_place.lat}x${result.polling_place.lon}?zoom=20&size=800x800`;
...
<div transition:slide>
	<h2 class="text-2xl font-bold">Your Polling Place</h2>
	...
	<div class="sm:flex">
		...
		<div class="my-auto mt-4 sm:my-auto sm:ml-6">
			<p class="text-lg font-bold">Polling Place:</p>
			<p class="text-lg">
				<a
					href={googleMapsLink}
			...
			<p class="mt-4 text-lg font-bold">
				Polling Place Hours: <span class="text-lg font-normal">7am-7pm, Nov. 5</span>
			</p>
