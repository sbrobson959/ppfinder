export const translations = {
	en: {
		...
		mapOfPollingPlace: 'Map of polling place',
		findOnGoogleMaps: 'Find polling place on Google Maps',
		address: 'Address',
		hours: 'Hours',
	...
	es: {
		...
		findOnGoogleMaps: 'Encuentre el lugar de votación en Google Maps',
		address: 'Dirección',
		hours: 'Horas',
