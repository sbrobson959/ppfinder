...
{#if initialized}
	...
	>
		<div class="mx-auto bg-blue-50">
			<div
				class="m-4 max-w-5xl rounded-xl border-2 border-zinc-200 bg-white p-6 text-2xl shadow-md"
			>
				...
				<p class="text-center text-sm text-zinc-600" class:mb-6={addressSelectedOnce}>
				...
				{:else if result}
					<div class="flex rounded-lg bg-red-100 p-4 text-lg" transition:slide={{duration: 300}}>
						<OctagonX class="my-auto mr-3.5 w-20 stroke-red-700 sm:w-auto" size="40" />
						<p class="my-auto text-base font-medium">
